...
function MENUWH()
  ...
  "2.💠Wallhack [SD 650/660]",    
  "3.💠Wallhack [SD 625]",
  "4.💠Wallhack [SD 625 V2]",    
  "5.💠Wallhack [Global]",
  "6.💠Wallhack [SD 410/435]",
  "7.💠Wallhack [SD 425/435]",
  "8.💠Wallhack [SD 425/435 V2]",
  "9.💠Wallhack [MEDIATEK]",
  "10.💠Wallhack [KIRIN]",    
  "🔙"
  }, nil, "💠 Wallhack Menu 💠")
...
gg.editAll("120",gg.TYPE_FLOAT)
gg.clearResults()
gg.toast("Wallhack SD 650/660 Active")
end
function WH3()
gg.clearResults()
gg.setRanges(gg.REGION_BAD)
...
if GNM[4] == true then AKM() end
if GNM[5] == true then M16() end
if GNM[6] == true then AWM() end
if GNM[7] == true then KAR98() end
if GNM[8] == true then M24() end
if GNM[9] == true then VSS() end
if GNM[10] == true then KARV2() end    
if GNM[11] == true then GEM() end
end
end
...
gg.clearResults()
gg.toast("Quick Open Scope Active")
end
...
function UPD()
  gg.alert("Add funtion Move Speed")
 end
function EXIT()
